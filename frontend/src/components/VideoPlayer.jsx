    ...
    >
      ...
      {!currentVideo && (
        ...
        >
          ...
          <p className='text-lg'>{t('controls.selectVideo')}</p>
        </div>
      )}

      {/* Instrucciones flotantes */}
      <div
        className='absolute bottom-2 left-1/2 -translate-x-1/2 bg-black/70 backdrop-blur-sm px-5 py-2.5 rounded-full text-xs text-gray-300 whitespace-nowrap'
        style={{
          zIndex: 100,
          pointerEvents: 'none',
          userSelect: 'none',
